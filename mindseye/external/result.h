...
*/
// https://github.com/oktal/result/tree/master
// NOTE: this does add extra data (and potential associated padding) when using these, obviously
// though in practice, these will only ever be in isolation on stack, 
// so I don't really care much about an extra few bytes here and there
#pragma once
