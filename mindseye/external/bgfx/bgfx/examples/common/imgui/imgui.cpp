...
static const bgfx::EmbeddedShader s_embeddedImguiShaders[] =
{
...
struct OcornutImguiContext
{
	...
	void create(float _fontSize, bx::AllocatorI* _allocator)
	{
		...
		m_program = bgfx::createProgram(
			  bgfx::createEmbeddedShader(s_embeddedImguiShaders, type, "vs_ocornut_imgui")
			, bgfx::createEmbeddedShader(s_embeddedImguiShaders, type, "fs_ocornut_imgui")
			, true
			);

		u_imageLodEnabled = bgfx::createUniform("u_imageLodEnabled", bgfx::UniformType::Vec4);
		m_imageProgram = bgfx::createProgram(
			  bgfx::createEmbeddedShader(s_embeddedImguiShaders, type, "vs_imgui_image")
			, bgfx::createEmbeddedShader(s_embeddedImguiShaders, type, "fs_imgui_image")
			, true
			);
